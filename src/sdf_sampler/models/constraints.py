...
class SamplePointConstraint(BaseConstraint):
    """Single point sample constraint with known signed distance.

    Direct training samples at specific 3D positions. Generated by multiple
    algorithms including flood_fill, voxel_regions, and normal_idw.
    """
    ...
    algorithm: str | None = Field(
        default=None, description="Algorithm that generated this constraint"
    )
